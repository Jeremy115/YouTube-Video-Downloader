...
MAYBE LATER?
#Shows when video is currently downloading
##############################################################################################

#create progress bar. 
progressbarVariable = customtkinter.DoubleVar()
progressbar = customtkinter.CTkProgressBar(root, orientation="horizontal", variable=progressbarVariable)
...
def on_progress(stream, chunk, bytes_remaining):
    ...
    progressbarVariable.set(pct_completed / 100)  # Update the progress bar
    root.update_idletasks() #refresh UI to show progressbar
